...
const request_specialist_sub_conversation = {
    ...
    parameters: {
        ...
        properties: {
            ...
            user_message_for_specialist: {
                type: FunctionDeclarationSchemaType.STRING,
                description: "A última mensagem relevante do usuário (ou uma mensagem inicial formatada) que o especialista deve processar primeiro."
            }
        },
        required: ["specialist_role", "initial_context", "user_message_for_specialist"]
    },
    /**
     * @param {object} args
     * @param {string} args.specialist_role
     * @param {string} args.initial_context
     * @param {string} args.user_message_for_specialist
     * @returns {Promise<object>} Objeto de sinalização.
     */
    function: async (args) => {
        if (!args.specialist_role || !args.initial_context || args.user_message_for_specialist === undefined) { // Checa undefined
            const errorMsg = "[Tool Signal Error] Argumentos inválidos para request_specialist_sub_conversation.";
        ...
        return {
            ...
            details: { // Retorna os detalhes para o Manager usar
                ...
                user_message_for_specialist: args.user_message_for_specialist
            }
        };
    }
};
